...
figure;
grid on;
semilogy(EbN0,average_uncoded_BER,'k-');
hold on;
semilogy(EbN0,average_coded_BER,'k-s');
...
semilogy(EbN0,average_uncoded_BER,'g-');
semilogy(EbN0,average_coded_BER,'g*-');
title('Hard decoding vs no encoding and decoding');
txt = ['Nbps: ' num2str(Nbps)];
text(-2,1e-3,txt)
legend('Uncoded','Hard Decoding with 10 iterations');
...
hold on;
semilogy(EbN0,average_coded_BER,'rp-');
title('Hard decoding vs no encoding and decoding');
txt = ['Nbps: ' num2str(Nbps)];
%text(-2,1e-3,txt)
%legend('Uncoded','Hard Decoding with 10 iterations');
...
grid on;
semilogy(EbN0,average_uncoded_BER,'b-');
hold on;
semilogy(EbN0,average_coded_BER,'bo-');
title('Hard decoding vs no encoding and decoding');
txt = ['Nbps: ' num2str(Nbps)];
%text(-2,1e-3,txt)
%legend('Uncoded','Hard Decoding with 10 iterations');
...
legend('Uncoded Nbps 1','Hard Decoding with 10 iterations Nbps 1 ','Uncoded Nbps 2','Hard Decoding with 10 iterations Nbps 2','Uncoded Nbps 4','Hard Decoding with 10 iterations Nbps 4','Uncoded Nbps 6','Hard Decoding with 10 iterations Nbps 6');
